...
namespace Wintils.Helpers
{
    public class RoundProgressPathConverter : IMultiValueConverter
    {
        ...
        {
            if (values?.ToList().Contains(DependencyProperty.UnsetValue) != false)
            ...
            using (var ctx = geo.Open())
            {
                ...
                if (!isFull)
                {
                    Point p1 = center + vector1 * outerR,
                        p2 = center + vector2 * outerR,
                        p3 = center + vector2 * innerR,
                        p4 = center + vector1 * innerR;
                ...
                {
                    Point p1 = center + vector1 * outerR,
                        p2 = center - vector1 * outerR,
                        p3 = center + vector1 * innerR,
                        p4 = center - vector1 * innerR;
